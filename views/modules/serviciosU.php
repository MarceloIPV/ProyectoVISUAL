...
<body>
    <!--tabla-->
    <table id="dg" title="ESTUDIANTES" class="easyui-datagrid" style="width:700px;height:250px;color:black;" url="models/cargar.php" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true">
        <thead>
            <tr>
